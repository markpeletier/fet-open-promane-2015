...
\TheProject aims at developing a control theory within nonequilibrium statistical thermodynamics, lifting irreversible thermodynamics and the theory of dynamical systems
to a unified tool for industrial
applications and technological development which includes the recent progress in fluctuation and response theory.  New technologies will benefit from the opportunities in the exploration of and the control via
macroscopic nonequilibria.  These are complex nonlinear systems composed of many constituents which
are driven subject to nonconservative forces or that are in contact with multiple reservoirs that impose conflicting
thermodynamic behavior, or for which the constituents are active, {\it i.e.}, containing objects that could be self-propelling.
 Our main hypothesis is that macroscopic
nonequilibria can be used for steering immersed
subsystems or probes, thus developing an emerging control theory using
nonequilibria together with the possibility of creating new macroscopic phases.
%
Among the expected deliverables are included enhanced stabilization of
metastable phases and the control of response parameters and transport coefficients,
crucial items in developing systematically new material properties. For
technological avenues our studies will reveal important insights, experimental and
computational methods for the characterization of real materials; for example by providing
...
%
Many efforts before focused on the destructive and information erasure roles of dissipation
and on the return to equilibrium. Time has come to comprehend and exploit the
