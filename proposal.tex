...
applications to include recent progress in nonequilibrium thermodynamics.
%
Current challenges and opportunities exist in exploring the new physics of
macroscopic nonequilibria: systems composed of many constituents which
are driven or active, i.e. objects that could be self-propelling, subject to
rotational forces or just in contact with multiple reservoirs that impose conflicting
thermodynamic behavior. Our main hypothesis is that macroscopic
nonequilibria can be used for steering immersed
subsystems or probes, thus developing an emerging control theory using
nonequilibria and the possibility of creating new macroscopic phases.
%
...
crucial items in developing new materials or material properties in systematic ways. For
...
and nonadditive, allowing unseen and novel behavior. Controlling it opens major
