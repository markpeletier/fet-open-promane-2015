...
We consider the vast class of active-particle suspensions in collaboration with the group in Padova, 
which will provide expert knowledge on nonequilibrium response theory.
%
...
we will collaborate with Stuttgart to connect our particle-based approach to their field theoretical approach.
...
of its constituents predict enhanced diffusion due to hydrodynamic interactions \cite{mikhailov-kapral:2015}.
%
...
which are relevant to metal-nanoparticle tracking and trapping technologies and emerging
nanoscopic Brownian heat engines, beyond the Markov limit. Therefore, we need to adapt the theory 
