...
\begin{wpobjectives}
\begin{compactitem}
\item Harness dissipation to improve the information-processing properties of nonequilibrium probes.
...
\item Define an operational and experimentally accessible notion of dynamical activity in the phenomenology of nonequilibrium thermodynamics.
\end{compactitem}
\end{wpobjectives}
...
\begin{tasklist}
  ...
  \begin{task}[title=Dissipation in the bistable switch,id=diss-t1,lead=TUE,wphases=0-12!1.0]
  ...
  \begin{task}[title=Role of dissipation in time,id=diss-t2,lead=TUE,wphases=12-30!1.0,partners={KUL}]
  ...
  \begin{task}[title=Dissipation in an oscillator,id=diss-t3,lead=TUE,wphases=30-48!1.0]
...
\begin{wpdelivs}
  \begin{wpdeliv}[due=24,id=wp-diss-1,dissem=PU,nature=R,lead=TUE]
    {Abstract characterization of the role of dissipation in the bistable switch.}
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=wp-diss-2,dissem=PU,nature=R,lead=TUE]
    {Characterization of the control of noise in an auto-nulling amplifier.}
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,id=wp-diss-3,dissem=PU,nature=R,lead=TUE]
    {Theoretical analysis of the role of dissipation in an oscillator.}
  \end{wpdeliv}
\end{wpdelivs}
\end{workpackage}
