...
\begin{tasklist}
  ...
  \begin{task}[title= Specification of dissipation in bistable switches,id=diss-t1,lead=TUE,wphases=0-20!1.0]
  ...
  \begin{task}[title=Operational control of constructive role of noise,id=diss-t2,lead=TUE,wphases={12-30,38-48},partners={KUL}]
  ...
  \begin{task}[title=Solving toy-models for harnessing dissipation in operational units,id=diss-t3,lead=TUE,wphases=24-48!1.0]
...
\begin{wpdelivs}
  \begin{wpdeliv}[due=24,id=wp-diss-1,dissem=PU,nature=R,lead=TUE,miles=framework]
    {Mathematical road-map and characterization for the role of dissipation in the bistable switch.}
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=wp-diss-2,dissem=PU,nature=DEM,lead=TUE,miles=data2]
    {DEM: Design of noise-control  in an auto-nulling amplifier.}
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,id=wp-diss-3,dissem=PU,nature=R,lead=TUE,miles=final]
