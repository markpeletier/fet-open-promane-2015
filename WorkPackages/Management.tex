...
\begin{wpdelivs}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=1,miles=start,id=tickets,dissem=PU,nature=DEC,lead=KUL]{Web site}
  \end{wpdeliv}
  \begin{wpdeliv}[due=6,miles=start,id=data,dissem=PU,nature=R,lead=KUL]{Hosting}
  \end{wpdeliv}
  \begin{wpdeliv}[due=24,miles=mymile1,id=comm,dissem=PU,nature=R,lead=KUL]{General public media}
  \end{wpdeliv}
  \begin{wpdeliv}[due=24,miles=mymile1,id=ca,dissem=CO,nature=R,lead=KUL]{Technological Report 1}
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,miles=finalmile,id=finalreport,dissem=PU,nature=R,lead=KUL]{Final report of the project}
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,miles=finalmile,id=ca,dissem=CO,nature=R,lead=KUL]{Technological Report 2}
  \end{wpdeliv}
\end{wpdelivs}
