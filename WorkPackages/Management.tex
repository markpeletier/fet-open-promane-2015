...
\begin{wpdelivs}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=1,id=website,dissem=PU,nature=DEC,lead=KUL]{Web site}
  \end{wpdeliv}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=24,id=TR1,dissem=PU,nature=R,lead=KUL]{Technological Report 1}
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,id=finalreport,dissem=CO,nature=R,lead=KUL]{Final report of the project}
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,id=TR2,dissem=PU,nature=R,lead=KUL]{Technological Report 2}
  \end{wpdeliv}
\end{wpdelivs}
