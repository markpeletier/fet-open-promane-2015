...
\begin{wpdelivs}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=24,id=TR1,dissem=CO,nature=R,lead=KUL]{Technological Report 1}
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,id=finalreport,dissem=PU,nature=R,lead=KUL]{Final report of the project}
  \end{wpdeliv}
  \begin{wpdeliv}[due=48,id=TR2,dissem=CO,nature=R,lead=KUL]{Technological Report 2}
  \end{wpdeliv}
\end{wpdelivs}
